...
export default function Home() {
  ...
  return (
    <div className='max-w-[430px] mx-auto px-4 pt-12 pb-4 w-screen h-screen'>
      <header className='flex items-center justify-between'>
        <Image src={logo} width={118} height={27} alt='logo' />
      ...
      <form onSubmit={handleSubmit} className='py-8 w-full flex flex-col text-foam'>
        ...
        <Editor
          ...
          className='my-4 font-mono bg-blueberry-600 border border-blueberry-300 rounded-md focus-within:ring-1 focus-within:ring-lime-600'
        />
      ...
      <div className='mt-6'>
        ...
        <textarea 
          className='my-4 bg-blueberry-600 w-full h-40 text-foam font-mono border border-blueberry-300 rounded-md px-4 py-3 outline-none focus:ring-1 focus:ring-lime-600' 
          name="question" 
          id="question"
          value={result}
        />
